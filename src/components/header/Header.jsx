        ...
        >
            <span className="menu-icon menu-icon-lightning" aria-hidden="true">
                <svg width="36" height="36" viewBox="0 0 24 24">
                  <path className="icon-stroke" d="M7 2v11h3v9l7-12h-4l4-8z" fill="none" stroke="transparent"
            ...
            <span className="menu-icon menu-icon-heart" aria-hidden="true">
                <svg width="30" height="30" viewBox="0 0 24 24">
                  <path className="icon-stroke"
                        ...
                        fill="none" stroke="transparent" strokeWidth="4" strokeLinejoin="round"/>
                  <path
                      d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"
                      fill="#d53a37" stroke="none"/>
                </svg>
            </span>
            Избранные покемоны
        </Link>
        ...
        <header className="header">
            ...
            <div className="header-content">
                ...
                <div className="header-right-block">
                    <button className="header-icon-btn search-animate" aria-label="Поиск"
                            onClick={handleSearchIconClick} ref={searchIconRef}>
                        <svg viewBox="0 0 24 24" fill="none">
                            <circle cx="11" cy="11" r="8" stroke="currentColor" strokeWidth="2"/>
                            <line x1="21" y1="21" x2="16.65" y2="16.65" stroke="currentColor" strokeWidth="2"/>
                        </svg>
                    </button>
                    <button className={`header-icon-btn theme-animate${isTransitioning ? ' switching' : ''}`}
                            aria-label="Сменить тему" onClick={toggleTheme}>
                        {isDarkTheme ? (
                            <svg viewBox="0 0 24 24" fill="none">
                    ...
                    <button className={`header-icon-btn burger-animate${menuOpen ? ' open burger-float' : ''}`}
                            aria-label={menuOpen ? 'Закрыть меню' : 'Открыть меню'} onClick={handleBurgerClick}>
                        <svg viewBox="0 0 24 24" fill="none">
