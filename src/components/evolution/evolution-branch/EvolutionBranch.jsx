...
import {useArrowCalculation} from '../../../hooks/useArrowCalculation.js';
import {EvolutionArrows} from '../evolution-arrows/EvolutionArrows.jsx';
import UniversalPokemonCard from '../../shared/UniversalPokemonCard.jsx';

/**
 * Компонент для отображения ветвистой эволюции
 */
export const EvolutionBranch = React.forwardRef(({node, currentPokemonId}, ref) => {
